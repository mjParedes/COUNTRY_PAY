  ...
  return (
    <div className='flex justify-center items-center   h-fit'>
        <div className=' border-rose-200 grid grid-rows-2  gap-2 my-10 '>
                ...
                <div className='bg-slate-100  rounded-md w-[800px]  h-[27rem]  shadow-lg grid grid-flow-row items-center justify-center '>
                ...
                <div className='bg-slate-100  rounded-md w-[800px] h-[27rem]  shadow-lg   flex justify-center items-center  '>
