  ...
  return (
    <div className='flex justify-center items-center   h-fit'>
        <div className=' border-rose-200 grid grid-rows-2  gap-2 my-10 '>
                ...
                <div className='bg-slate-100  rounded-md w-[800px] h-[400px] shadow-lg grid grid-flow-row justify-center items-center flex-col '>
                    <h3 className='text-2xl font-medium text-Grises/600 first-letter:uppercase'>movimientos recientes</h3>
                    <div className='flex justify-between items-center' >
                        <div className='w-[3.6rem] h-14 rounded-full bg-Morado/700'>
                            <span className='text-2xl uppercase'>j</span>
                        </div>
                        <div>
