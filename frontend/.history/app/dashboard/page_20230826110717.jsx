  ...
  return (
    <div className='flex justify-center items-center   h-fit'>
        <div className=' border-rose-200 grid grid-rows-2  gap-2 my-10 '>
                ...
                <div className='bg-slate-100  rounded-md w-[800px] h-[400px] shadow-lg grid grid-flow-row items-center '>
                <div className='text-left w-2/3 h-1/2 flex flex-col justify-center'>
