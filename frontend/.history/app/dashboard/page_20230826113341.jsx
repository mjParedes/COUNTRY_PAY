  ...
  return (
    <div className='flex justify-center items-center   h-fit'>
        <div className=' border-rose-200 grid grid-rows-2  gap-2 my-10 '>
                ...
                <div className='bg-slate-100  rounded-md w-[800px] h-fit  shadow-lg  flex justify-center items-center  '>
                   <div className='flex flex-col h-2/3 w-3/4 justify-between items-start p-28'>
                    <h3 className='text-2xl font-medium text-Grises/600 first-letter:uppercase text-center'>movimientos recientes</h3>
                    <div className='flex justify-between items-center w-full border-28p-28' >
