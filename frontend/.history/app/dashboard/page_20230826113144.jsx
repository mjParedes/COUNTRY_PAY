  ...
  return (
    <div className='flex justify-center items-center   h-fit'>
        <div className=' border-rose-200 grid grid-rows-2  gap-2 my-10 '>
                ...
                <div className='bg-slate-100  rounded-md w-[800px] h-[400px] shadow-lg  flex justify-center items-center  '>
                   <div className='flex flex-col h-1/2 w-1/2 justify-between items-start'>
