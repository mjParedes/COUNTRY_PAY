    ...
    <div className='flex justify-center items-center   h-fit'>
        <div className=' border-rose-200 grid grid-rows-2  gap-2 my-10 '>
                ...
                <div className='text-left w-1/2 h-1/2 flex flex-col justify-center'>
                    ...
                    <p className='font-medium text-8xl text-Morado/800 flex justify-start items-end'> $ 40,00 <span className='uppercase text-base font-semibold text-black py-2 px-4 bg-Morado/50' >usd</span> </p>
