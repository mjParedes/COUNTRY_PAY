...
function MovimientComp() {
  ...
  return (
   ...
   <div className='bg-slate-100  rounded-md w-[54rem] h-[26rem]  shadow-lg   grid grid-flow-row justify-center items-center '>
         ...
         
                   {
                    MOVIMENTAPI.map(({id, nombre, date, success, money}) => (
                        <div key={id} className='flex flex-col h-2/3 w-2/3 justify-between items-center m-auto'>
