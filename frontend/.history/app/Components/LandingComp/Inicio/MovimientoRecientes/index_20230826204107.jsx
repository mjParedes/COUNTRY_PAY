  ...
  return (
    ...
    <div className='flex flex-col h-2/3 w-3/4 justify-between items-start'>
     ...
     <div className='flex justify-between items-center w-full ' >
        {MOVIMENTAPI.map(({movimient}) => 
              <div key={movimient.id} className='flex justify-start items-center w-full'>
              ...
              <h4 className='capitalize font-bold  text-base '> {movimient.nombre}</h4>
              <div className='flex justify-between items-center w-full '>
