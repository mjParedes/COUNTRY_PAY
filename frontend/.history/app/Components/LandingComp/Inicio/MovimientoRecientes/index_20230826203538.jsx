...
function MovimientComp() {
  ...
  return (
   ...
   <div className='bg-slate-100  rounded-md w-[54rem] h-[26rem]  shadow-lg   flex flex-col justify-around items-center  '>
         ...
         
                   {
                    MOVIMENTAPI.map(({id, nombre, date, success, money}) => (
                        <div key={id} className='flex flex-col h-2/3 w-1/2 justify-normal items-center m-auto'>
