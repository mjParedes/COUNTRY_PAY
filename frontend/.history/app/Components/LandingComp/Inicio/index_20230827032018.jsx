...
<<<<<<< HEAD
    ...
    <Link href={"/loginPage"} className="w-[143px] h-[48px] rounded-md flex justify-center items-center text-Grises/100  duration-700" >Iniciar Sesion</Link >
=======
    <Link href={"/Signup"} className="w-[143px] h-[48px] rounded-md flex justify-center items-center mr-2 text-Grises/100 bg-Morado/600 hover:bg-Azul/600 duration-700" >Registrarme</Link >
...
>>>>>>> 1b0748a0bfb8c61c244af4bf50de68231f33d671
</div>
</div>
</section>
  )
