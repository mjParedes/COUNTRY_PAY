      ...
      <Link href={"/"}>
            ...
            <ul className="capitalize flex justify-around items-center w-1/2 ">
                {
                    FOOTERLINKS.map(({label, route}) =>(
                        <li key={route}>
                            <Link href={route} className="hover:text-Morado/400 duration-500 " > {label} </Link>
                        </li>
                    ))
                }
            </ul>
        ...
        <div className="w-1/4 flex items-center justify-evenly" >
          <span className="  w-full h-full flex justify-center items-center ">
            <BiLogoInstagram  className="w-[40px] h-[40px] hover:text-Morado/500 transtion-colors duration-500 cursor-pointer  "/>
          </span>
          <span className="  w-full h-full flex justify-center items-center ">
            <BiLogoLinkedinSquare className="w-[40px] h-[40px] hover:text-Morado/500 transtion-colors duration-500 cursor-pointer "/>
          </span>
        </div>
      </div>
    </footer>
